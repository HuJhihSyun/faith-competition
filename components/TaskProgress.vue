...
<template>
  <div
    class="relative flex justify-between items-center w-full mx-auto rounded-sm px-2 sm:px-3 py-2 overflow-hidden border border-b-2 border-r-3 border-[#D97F17] backdrop-blur-xs transition-all duration-300"
  >
    <div class="w-full flex flex-col items-center justify-center">
      <div class="w-full flex justify-between items-center">
        <h4 class="flex justify-center items-center text-xs md:text-sm text-[#d1760f] whitespace-nowrap tracking-tight">
          <slot name="icon"></slot>
