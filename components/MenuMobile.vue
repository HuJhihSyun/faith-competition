        ...
        <ul class="p-0 m-0 flex flex-row">
          ...
          >
            <NuxtLink
              ...
              :class="{ 'text-[#d1760f] bg-gradient-to-br from-[#d1760f]/10 to-[#d1760f]/50': isActive(item.path) }"
              @click="handleToggle"
            >
